...
var file_crypto_proto_rawDesc = []byte{
	...
	,
	...
	0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x12, 0x10, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e,
	0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x49, 0x44, 0x1a, 0x10, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x6f, 0x2e, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x49, 0x44, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f,
...
var file_crypto_proto_depIdxs = []int32{
	...
	1, // 1: crypto.CryptoService.InsertCrypto:input_type -> crypto.InsertCryptoRequest
	4, // 2: crypto.CryptoService.ReadCrypto:input_type -> crypto.CryptoID
	2, // 3: crypto.CryptoService.UpdateCrypto:input_type -> crypto.UpdateCryptoRequest
	4, // 4: crypto.CryptoService.DeleteCrypto:input_type -> crypto.CryptoID
	4, // 5: crypto.CryptoService.InsertCrypto:output_type -> crypto.CryptoID
	0, // 6: crypto.CryptoService.ReadCrypto:output_type -> crypto.Crypto
	3, // 7: crypto.CryptoService.UpdateCrypto:output_type -> crypto.UpdateCryptoResponse
	4, // 8: crypto.CryptoService.DeleteCrypto:output_type -> crypto.CryptoID
